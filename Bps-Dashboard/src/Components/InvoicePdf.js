...
const InvoicePDF = forwardRef(({ invoice, onShare }, ref) => {
        ...
        >
            ...
            >
                ...
                <Box className="col-50" sx={{ width: { xs: '100%', sm: '48%' } }}>
                    ...
                    <Typography>City, Country - 00000</Typography>
                    <Typography><strong>Phone:</strong> 📞 {invoice.phone}</Typography>
                </Box>
            </Box>
            ...
            <Box mb={3}>
                ...
                >
                    {[
                        { label: 'No. Of', value: 'Item01' },
                        { label: 'Insurance', value: '₹ 100' },
                        { label: 'VPP Amount', value: 'Rs. 1000' },
                        { label: 'To Pay/Paid', value: 'Rs. 1000' },
